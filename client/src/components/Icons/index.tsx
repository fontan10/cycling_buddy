...
export const StarIcon = ({ className, fill = 'currentColor' }: { className?: string; fill?: string }) => (
  <svg width="28" height="28" viewBox="0 0 24 24" aria-hidden="true" className={className}>
    <polygon
